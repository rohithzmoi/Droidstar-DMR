...
public:
    ...
    QString getFriendlyName(const QString& deviceIdentifier);
    QString mapFriendlyNameToDevice(const QString &friendlyName);
    //QStringList devices = audioEngine->discover_audio_devices(1);
